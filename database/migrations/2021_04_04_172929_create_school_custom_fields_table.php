...
class CreateSchoolCustomFieldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('school_custom_fields', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('school_custom_fields');
    }
}
