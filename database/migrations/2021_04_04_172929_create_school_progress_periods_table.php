...
class CreateSchoolProgressPeriodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('school_progress_periods', function (Blueprint $table) {
            $table->integer('marking_period_id')->primary();
            $table->decimal('syear', 4, 0)->nullable();
            $table->decimal('school_id', 10, 0)->nullable();
            $table->decimal('quarter_id', 10, 0)->nullable()->index('school_progress_periods_ind1');
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->index(['syear', 'school_id', 'start_date', 'end_date'], 'school_progress_periods_ind2');
        });
    }
    ...
    {
        Schema::dropIfExists('school_progress_periods');
    }
}
