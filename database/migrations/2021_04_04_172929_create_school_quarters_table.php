...
class CreateSchoolQuartersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('school_quarters', function (Blueprint $table) {
            ...
            $table->decimal('semester_id', 10, 0)->nullable()->index('school_quarters_ind1');
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->index(['syear', 'school_id', 'start_date', 'end_date'], 'school_quarters_ind2');
        });
    }
